...
@implementation UIDevice (BXHCategory)
...
{
    double sysVersion = [[self class] systemVersion];
...
- (BOOL)isJailbroken
{
    ...
    NSString *path = [NSString stringWithFormat:@"/private/%@", [NSString generateUuidString]];
