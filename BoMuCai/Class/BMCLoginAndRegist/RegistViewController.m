...
@interface RegistViewController () <RegistInputTextFiledDelegate>
...
- (void)nextBtnAction
{
    ...
    RegistPasswordViewController *vc = [[RegistPasswordViewController alloc] initWithPhone:self.phoneTextFiled.inputTextFiled.text code:self.codeTextFiled.inputTextFiled.text];
