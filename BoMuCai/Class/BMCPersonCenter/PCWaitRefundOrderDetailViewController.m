...
@interface PCWaitRefundOrderDetailViewController () <UITableViewDelegate, UITableViewDataSource,CarSectionHeaderViewDelegate,PCApplyRefundResultViewControllerDelegate>
...
@implementation PCWaitRefundOrderDetailViewController
...
- (PCOrderDetailStatueCell *)statueSecCell
{
    if (!_statueSecCell)
    {
        ...
        NSString *str = @"订单状态：待退款";
        _statueSecCell.statueLabel.attributedText = [str attributStrWithTargetStr:@"待退款" color:Color_Main_Dark];    }
