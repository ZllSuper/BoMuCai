...
- (void)configCollectionView {
    ...
    CGFloat top = margin + 0;
//    if (iOS7Later) top += 20;
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(margin, top, self.view.tz_width - 2 * margin, [UIScreen mainScreen].bounds.size.height - 64 - 50 - top) collectionViewLayout:layout];
...
- (void)configBottomToolBar {
    UIView *bottomToolBar = [[UIView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 64 - 50, self.view.tz_width, 50)];
