...
- (UIImage *)creatViewImage:(CGSize)size
{
    ...
    //保存图像
    NSString *path = [NSHomeDirectory() stringByAppendingFormat:@"/%@.png",@"sfdafas"];
    NSLog(@"path = %@",path);
